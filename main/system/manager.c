    ...
    switch (wired_adapter.system_id) {
        ...
        case PS2:
            /* La consola real usa un unico boton fisico momentaneo tanto
               ...
               un momento.
               Open-drain: el cableado es directo (sin transistor/relay
               de por medio) a la linea de la consola, en paralelo con el
               boton fisico real. Sin open-drain, el GPIO empuja
               activamente un nivel todo el tiempo y compite/pelea contra
               la consola y el boton por el control de esa linea. En
               open-drain, el GPIO solo tira a LOW cuando esta activo, y
               el resto del tiempo la suelta -- igual que un boton real. */
            hw_config.port_cnt = 2;
